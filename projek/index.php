  ...
  <body>
    ...
    <section id="product" class="container">
      ...
      <div class="flex">
        <div class="card product">
          ...
          <a href="product/GPU.php" class="btn"> Shop Now </a>
        </div>
        ...
        <div class="product card">
          ...
          <a class="btn" href="product/Display.php"> Shop Now </a>
        </div>
        ...
        <div class="product card">
          ...
          <a class="btn" href="product/Laptop.php"> Shop Now </a>
        </div>
      </div>
    </section>
    ...
    <footer>
      ...
      <div class="copyright">
        <span class="author">
          Crafted with Effort by Muhammad Fajar
